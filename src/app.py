...
- Blueprint 层：按功能域拆分路由（status, sessions, chat, scene, combat,
  combat_nodes, documents, index, llm, wiki, environment, assets, memories,
  cards, worldbook, plot_graphs, story）
